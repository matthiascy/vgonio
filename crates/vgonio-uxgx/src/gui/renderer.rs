...
///
/// - `paint` is called after `setup` and is given access to the [`wgpu::RenderPass`] so that it can
///   issue draw commands into the same [`wgpu::RenderPass`] that is used for all other egui
///   elements.
///
