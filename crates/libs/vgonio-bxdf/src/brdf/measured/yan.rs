...
use crate::brdf::measured::{BrdfSnapshot, BrdfSnapshotIterator, MeasuredBrdf};
#[cfg(feature = "io")]
use std::path::Path;
...
use vgonio_core::{
    bxdf::{
        BrdfParam, BrdfParamKind, BrdfProxy, MeasuredBrdfKind, Origin, OutgoingDirs, ProxySource,
    },
...
impl Yan18Brdf {
    ...
    pub fn load_from_exr<P: AsRef<Path>>(
        ...
        use vgonio_core::{math::Vec2, units::deg};
...
impl AnyMeasuredBrdf for Yan18Brdf {
    vgonio_core::any_measured_brdf_trait_common_impl!(Yan2018Brdf, Yan2018);
