use std::fmt::Debug;
use vgonio_core::math::{cart_to_sph, cos_theta, Vec3};

use crate::{brdf::analytical::microfacet::MicrofacetBrdf, distro::TrowbridgeReitzDistribution};
use vgonio_core::bxdf::{AnalyticalBrdf, BrdfFamily, MicrofacetDistribution, MicrofacetDistroKind};
#[cfg(feature = "fitting")]
use vgonio_core::{
    math::{rcp_f64, sqr},
    optics::{fresnel, Ior},
