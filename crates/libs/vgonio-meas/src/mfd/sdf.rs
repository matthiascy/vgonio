use crate::params::SdfMeasurementParams;
...
impl MeasuredSdfData {
    /// Save the measured slope distribution as an image.
    ///
    /// The image is actually a histogram of the slope. Each pixel in the image
    ...
    pub fn pmf(&self, azi_bin_width: Radians, zen_bin_width: Radians) -> SdfPmf {
        ...
        let zen_range = StepRangeIncl::new(Radians::ZERO, Radians::HALF_PI, zen_bin_width);
