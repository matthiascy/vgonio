...
pub mod vgms {
    ...
    pub fn read<R: Read + Seek>(
        ...
        let samples = vgn_core::io::read_f32_data_samples(
            reader,
    ...
    pub fn write<W: Write + Seek>(
        ...
        match header.meta.encoding {
            FileEncoding::Ascii => {
                vgn_core::io::write_data_samples_ascii(writer, samples, header.extra.cols)
            },
            FileEncoding::Binary => vgn_core::io::write_f32_data_samples_binary(
                writer,
                header.meta.compression,
                samples,
            ),
...
pub fn read_ascii_dong2015<R: BufRead>(
    ...
    vgn_core::io::read_ascii_samples(reader, rows * cols, &mut samples).map_err(|err| {
        VgonioError::new(
...
pub fn read_omni_surf_3d<R: BufRead>(
    ...
    vgn_core::io::read_binary_samples(reader, (rows * cols) as usize, &mut samples).map_err(
        |err| {
