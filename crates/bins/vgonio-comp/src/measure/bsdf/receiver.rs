...
use crate::{
    app::cache::RawCache,
    measure::bsdf::{SingleBsdfMeasurementStats, SingleSimResult},
};
...
#[cfg(feature = "vdbg")]
use vgonio_meas::bsdf::trace::Energy;
use vgonio_meas::bsdf::{params::BsdfMeasurementParams, trace::BounceAndEnergy};
