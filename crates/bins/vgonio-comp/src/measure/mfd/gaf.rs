use crate::{app::cache::RawCache, measure::AnyMeasured};
...
use vgonio_meas::{
    mfd::{params::GafMeasurementParams, MeasuredGafData},
...
/// depending on the format of the colour attachment used. At the blending
...
impl Uniforms {
    const SIZE_IN_BYTES: wgpu::BufferAddress = size_of::<Self>() as u64;
}
...
impl ColorAttachment {
    ...
    /// Returns true if the colour attachment is 8-bit.
    /// Otherwise, it is 10-bit. This is used to determine how to save the data.
    /// Also, 8-bit colour attachment is used for debugging.
...
pub struct MeasurementPoint {
    /// The direction from the centre to the measurement location.
    pub view_dir: Vec3,
