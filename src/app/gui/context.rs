...
use crate::{app::gui::VgonioEvent, error::Error};
...
#[repr(C)]
struct UiUniform {
    /// Size of the window in logical pixel.
    window_size: [f32; 2],
...
impl UiUniform {
    fn new(window_size: &WindowSize) -> Self {
        let (logical_width, logical_height) = window_size.logical_size();
        Self {
...
/// Buffer used for rendering reducing the number of allocated buffers by
...
impl GuiContext {
    ...
    pub fn new(
        ...
        let uniform_buffer = device.create_buffer_init(&wgpu::util::BufferInitDescriptor {
            ...
            contents: bytemuck::cast_slice(&[UiUniform::default()]),
    ...
    pub fn update_buffers(
        ...
        self.update_buffer(
            ...
            BufferType::Uniform,
            0,
            bytemuck::cast_slice(&[UiUniform::new(win_size)]),
        );
            ...
            match primitive {
                Primitive::Mesh(mesh) => {
                    ...
                    if i < index_size {
                        ...
                        self.index_buffers.push(device.create_buffer_init(
