...
pub struct MicrofacetMaskingShadowing {
    // /// The start azimuth of the measurement.
    // pub azimuth_start: Radians,
    // /// The end azimuth of the measurement (inclusive).
    ...
    // /// The end zenith of the measurement (inclusive).
...
impl MicrofacetMaskingShadowing {
    ...
    pub fn bins_count(&self) -> usize {
        (self.params.azimuth.step_count_wrapped() * self.params.zenith.step_count()).pow(2)
    }
